    ...
    <footer className="bg-gray-800 text-white py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {/* About section */}
          <div>
            <h3 className="text-xl font-medium mb-4">東京ゲストハウス(黒岩)</h3>
            <p className="text-gray-300 mb-4">
            東京の中心部にある静かなオアシス。伝統的な日本の宿泊施設とモダンな快適さを兼ね備えています。
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                <MapPin className="h-5 w-5 mr-3 mt-0.5 text-emerald-400" />
                <span className="text-gray-300">
                  1-2-3 Shinjuku, Tokyo 160-0022, Japan
                </span>
              </li>
              ...
              <li className="flex items-center">
                ...
                <span className="text-gray-300">info@tokyoguesthouse.com</span>
              </li>
              <li className="flex items-center">
        ...
        <div className="mt-8 pt-8 border-t border-gray-700 text-center text-gray-400 text-sm">
          <p>© {new Date().getFullYear()} Tokyo Guesthouse. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
